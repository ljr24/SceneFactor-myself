...
OMP_NUM_THREADS=4 CUDA_VISIBLE_DEVICES=0,1 TOKENIZERS_PARALLELISM=false /rhome/abokhovkin/miniconda3/envs/scenefactor/bin/python -u inference_separate_geo_stage2.py -e /cluster/andram/abokhovkin/SceneFactor/stage3_uncond_new/superres_32_spatial_old_l2_camready -d /cluster/andram/abokhovkin/data/Front3D/baselines/SceneFactor_v2/recon_semantic_16sp_old_l2_med_qwen_finetune_it400k_450scenes_camready_separate -n ${SLURM_ARRAY_TASK_COUNT} -p ${SLURM_ARRAY_TASK_ID}