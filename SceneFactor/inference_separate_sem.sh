...
OMP_NUM_THREADS=4 CUDA_VISIBLE_DEVICES=0,1 /rhome/abokhovkin/miniconda3/envs/scenefactor/bin/python -u inference_separate_sem.py -e /cluster/andram/abokhovkin/SceneFactor/stage3_uncond_new/sem_16spatial_l2_med_qwen_fixed_finetune_camready -d /cluster/andram/abokhovkin/data/Front3D/baselines/SceneFactor_v2/recon_semantic_16sp_old_l2_med_qwen_finetune_it400k_450scenes_camready_separate -s 7