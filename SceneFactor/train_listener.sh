...
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=0,1,2,3 TORCH_DISTRIBUTED_DEBUG=DETAIL /rhome/abokhovkin/miniconda3/envs/scenefactor/bin/python -u train_listener.py -e /cluster/falas/abokhovkin/rgb-d-diffusion/Diffusion-SDF/stage1_sdf_new/listener_model_2/ -b 32 -w 8
