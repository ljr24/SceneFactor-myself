...
SAVEDIR = '/cluster/balar/abokhovkin/data/Front3D/train_chunks_sem_lowres_sem_canonic'
        ...
        try:
            ...
            for chunk_id in scene_map_keys_furniture_nn:
                ...
                valid_range_min_point = [[valid_range[0][0], valid_range[0][1], valid_range[0][2]],
                                         [max(valid_range[0][0], valid_range[1][0] - subchunk_size), max(valid_range[0][1], valid_range[1][1] - subchunk_size), max(valid_range[0][2], valid_range[1][2] - subchunk_size)]]
                ...
                for i in range(num_subchunks):
                    ...
                    random_max_point = random_min_point + subchunk_size
                    ...
                    if num_furniture_voxels >= 10000: # 18000
                ...
                if len(all_subchunk_bounds) != 0:
                    ...
                    for k in range(len(all_subchunk_coord_bounds)):
                        # print(all_subchunk_bounds.shape, subchunks_together_bounds.shape, len(all_subchunk_coord_bounds))
