...
OMP_NUM_THREADS=4 CUDA_VISIBLE_DEVICES=0,1 /rhome/abokhovkin/miniconda3/envs/scenefactor/bin/python -u inference_sem_to_geo_overlap_edit_stage1_onestage.py -e /cluster/andram/abokhovkin/SceneFactor/stage3_uncond_new/geo_16_spatial_old_l2 -d /cluster/andram/abokhovkin/data/Front3D/baselines/SceneFactor_v2/editing -k 4